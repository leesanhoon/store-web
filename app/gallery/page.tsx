    ...
    <div className="surface-gradient">
      <div className="page-shell py-6 sm:py-8">
        <section className="panel-strong p-6 sm:p-8 md:p-10">
          ...
          <p className="mt-4 max-w-3xl text-base leading-8 text-slate-600 md:text-lg">Bộ mẫu mô phỏng phong cách quán chuỗi cà phê, dùng để chốt màu, chất liệu và kiểu in trước khi sản xuất thật.</p>
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link href="/products" className="button-primary">Xem sản phẩm</Link>
            <Link href="/cart" className="button-secondary">Gửi yêu cầu báo giá</Link>
          </div>
        </section>
