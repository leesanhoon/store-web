                ...
                <section className="panel-strong p-6 sm:p-8 md:p-10">
                    ...
                    <div className="mt-8 grid gap-4 md:grid-cols-[1fr_1fr_auto]">
                        <input
                            ...
                            placeholder="Mã đơn (ví dụ RQ-123456)"
                            ...
                            <article className="panel p-6">
                                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                                    <div>
                                        ...
                                        <h2 className="mt-2 text-2xl font-semibold text-header">{order.businessName || "Đơn in"}</h2>
                                ...
                                {order.mockupFileName ? (
                                    <div className="mt-4 rounded-2xl bg-amber-50 p-4 text-sm font-medium text-amber-900">
                                        File mockup: {order.mockupFileName}
                                    </div>
                                ) : null}
                            </article>
                        ) : (
                            <div className="panel p-6 text-sm font-medium text-slate-600">
                                Chưa tìm thấy đơn. Hãy nhập đúng mã đơn và số điện thoại.
                            </div>
                        )}
                    </div>
                    ...
                    <aside className="space-y-4">
                        ...
                        <div className="panel p-6">
                            ...
                            <p className="mt-3 text-sm font-medium leading-7 text-slate-600">
                                Nếu chưa có mã đơn, hãy kiểm tra email/Zalo hoặc liên hệ bộ phận tư vấn để nhận mã.
                            </p>
                        </div>
                    </aside>
                </section>
