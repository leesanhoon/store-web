        ...
        >
            ...
            <div
                ...
                style={{
                    ...
                    transition:
                        "opacity 0.4s var(--ease-spring), transform 0.4s var(--ease-spring)",
                }}
            >
                <div className="relative h-12 w-12">
                    <svg
                        className="h-12 w-12 animate-[overlay-spin_1s_var(--ease-spring)_infinite]"
                        viewBox="0 0 48 48"
                        fill="none"
                    >
                        <circle
...
export function InlineSpinner({
    ...
    return (
        <svg
            className={`animate-[overlay-spin_1s_var(--ease-spring)_infinite] ${className}`}
            viewBox="0 0 24 24"
            fill="none"
        >
            <circle
