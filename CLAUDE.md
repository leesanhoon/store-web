...
**Next.js 16** app with React 19, Tailwind CSS 4, and TypeScript. Mobile-first e-commerce storefront for a Vietnamese cup/lid printing business ("In ly sờ to"). The UI language is Vietnamese.
